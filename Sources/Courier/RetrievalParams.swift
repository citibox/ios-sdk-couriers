...
public struct RetrievalParams {
    ...
    ///   - citiboxId: Mandatory. String. ID for the Citibox transaction to be collected. The citiboxId value is generated by Citibox during a delivery through Deeplink.
    ...
    public init(accessToken: String, citiboxId: String, sandbox: Bool = false, debug: Bool = false) {
